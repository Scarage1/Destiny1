...
| T12 Docs/demo/submission | In Progress | root [README.md](README.md), CI [/.github/workflows/ci.yml](.github/workflows/ci.yml), and issue templates created; demo/link finalization pending |
